 ...
 <div class="video">
    ...
    <el-row :gutter="24">
        ...
        <div class="video_content">
            <!-- <video src="./video/1.mp4" ref="video" class="one_video"   muted autoplay></video>  -->
        <video src="./video/1.mp4" loop class="one_video"   muted autoplay></video> 
        <div class="control">
     ...
     <div class="video_right">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <div class="grid-content four">
                <video src="./video/t1.mp4" loop class="one_video"  muted autoplay></video> 
...
　　        },
        ...
        mounted () {
            ...
            //发送请求获取坐标
            var _this=this
            axios.get('http://124.70.40.181:8257/labels/matching.do', {
            params: {
  ...
  .grid-content {
    ...
    .video_right{
        ...
        .four{
            ...
            // background-image: url("./output/zihuang.jpg");
            //     background-size: 100% 100%;
            //     background-repeat: no-repeat;
            .one_canvas{
                height:45vh;
